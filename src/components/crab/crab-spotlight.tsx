            ...
            <div className="grid grid-cols-3 gap-3">
              {feedItems.map((f) => (
                <button
                  ...
                  className="rounded-[var(--radius-lg)] border-2 border-[var(--border-strong)] bg-[var(--background)] shadow-[var(--shadow-strong)] p-3 text-center hover:scale-[0.99] transition disabled:opacity-60"
